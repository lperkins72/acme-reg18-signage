...
```text
?tenant=acme&region=reg18&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg18&device=nuc-001
```
...
5. test one launcher such as `/devices/reg18/nuc-001.html`

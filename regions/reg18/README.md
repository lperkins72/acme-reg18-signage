...
This folder is the region-default content layer for `reg18`.
...
- `regions/reg18/data/primary-assets.json`
- `regions/reg18/data/primary.json`
- `regions/reg18/data/footer.json`
- `regions/reg18/data/primaryending.json`
- `regions/reg18/assets/primary/manifest.json`
- `regions/reg18/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg18`.
